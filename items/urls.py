...
urlpatterns=[
    ...
    path('class/item/<int:pk>/',views.ItemRetrieveUpdateDestroyAPIView.as_view()),

    # path('viewset/category/',views.CategoryViewSet.as_view({'get':'list','post':'create'})),
    # path('viewset/category/<int:pk>/', views.CategoryViewSet.as_view({'get': 'retrieve', 'put': 'update',
    #                                                                   'delete':'destroy'})),
